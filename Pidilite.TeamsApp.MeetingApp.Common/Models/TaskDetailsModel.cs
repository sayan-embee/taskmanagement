...
namespace Pidilite.TeamsApp.MeetingApp.Common.Models
{
    public class TaskDetailsModel
    {
        ...
        [JsonProperty("taskOriginalClosureDate")]
        public DateTime? TaskOriginalClosureDate { get; set; }
        ...
        [JsonProperty("taskFileUpload")]
        public List<TaskFileUploadModel> TaskFileUpload { get; set; }

        [JsonProperty("taskParticipant")]
        public List<TaskParticipantModel> TaskParticipant { get; set; }
        ...
        public List<TaskChecklistModel> taskChecklistModel { get; set; }

        [JsonProperty("taskSelfActionHistory")]
        public List<TaskSelfActionHistoryModel> taskSelfActionHistory { get; set; }

        [JsonProperty("taskLog")]
        public List<TaskLogModel> taskLog { get; set; }
