...
import { getmeetingtitlesAPI, getMeetingTypesAPI, getTimeZoneAPI, getAllTeamsAPI, getUserProfileAPI, getFileExtensionsAPI, createMeetingFileAPI, deleteMeetingFilesAPI, updateMeetingeAPI, getDivisionsAPI, getVerticalsAPI, getFilteredUsersAPI, getMeetingDetailsByParentIdAPI, getRoomsAPI, findMeetingTimesAPI, roomScheduleAPI, getAllRoomsAPI, getAllDistributionListGroups } from './../../apis/APIList'
import { Text, Button, Flex, FlexItem, FormInput, FormDropdown, FormDatepicker, Loader, Datepicker, Dropdown, Input, Alert, OpenOutsideIcon, Tooltip } from '@fluentui/react-northstar';
import { Persona, PersonaSize } from '@fluentui/react';
import * as microsoftTeams from "@microsoft/teams-js";
import { TagIcon, ChannelShareIcon, LocationIcon, FilesAftereffectsIcon, EditIcon, NotesIcon, CalendarIcon, SpeakerPersonIcon, CalendarAgendaIcon, InfoIcon } from "@fluentui/react-northstar";
...
type MyState = {
    ...
    IsPartialMSGraphUpdate?: boolean;
    IsConducted?: any;
    selectedSpoDriveId?: string;
    selectedSpoItemId?: string;
    selectedSpoWebUrl?: string;
    selectedMeetingTitleFileName?: string;
};
...
class CreateMeeting extends React.Component<ICreateMeetingProps, MyState> {
    ...
    getVerticals() {
        getVerticalsAPI().then((res: any) => {
            ...
            res.data.filter((e: any) => e.verticalName === this.state.verticalName && e.divisionName === this.state.divisionName).map((e: any) => {
                this.setState({
        ...
        if (data) {
            this.state.channelData.filter((e: any) => e.channelId === data.id).map((e: any) => {
                this.setState({
                    ...
                    IsPartialMSGraphUpdate: this.state.edit ? true : false
                })
            })
        }
        else {
        ...
        if (data) {
            this.state.meetingTypeList.filter((e: any) => e.typeName === data).map((e: any) => {
                this.setState({
                    ...
                    if (this.state.meetingType !== "Other" || this.state.meetingType !== "CFT") {
                        this.getMeetingtitles();
                    }
                    else{
                        this.setState({
                            ...
                            selectedSpoItemId:"",
                            selectedSpoWebUrl:"",
                            selectedMeetingTitleFileName: "",
                            spoDriveId: "",
                            spoItemId:"",
                            spoWebUrl:"",
                            meetingTitleFileName: "",
                            dropOption: ["Upload OAAP Template"],
                        })
                    }
    ...
    getMeetingtitles() {
        ...
        getmeetingtitlesAPI(data).then((res: any) => {
            ...
            this.setState({
                ...
                if (this.state.edit) {
                    this.selectMeetingTitle(this.state.meetingTitle)
                }
            })
        })
    }
    ...
    selectMeetingTitle(data: any) {
        this.state.meetingTitlesList.filter((e: any) => e.meetingTitle === data).map((e: any) => {
            ...
            this.setState({
                ...
                meetingTitle: data,
                selectedSpoDriveId: e.spoDriveId,
                selectedSpoItemId:e.spoItemId,
                selectedSpoWebUrl:e.spoWebUrl,
                selectedMeetingTitleFileName: e.meetingTitleFileName
            })
        })
    }
    ...
    selectRoomFunction(data: any) {
        // console.log("room", data)
        if (data) {
            this.state.allRoomData.filter((e: any) => e.id === data.id).map((ele: any) => {
                this.setState({
    ...
    getMeetingData(id: any, parentId: any) {
        getMeetingDetailsByParentIdAPI(id, parentId).then((res) => {
            ...
            this.setState({
                ...
                IsConducted: res.data.isConducted,
                ...
                meetingTitleFileName: res.data.sPOFileUpload ? res.data.sPOFileUpload.fileName : null,
                spoDriveId: res.data.sPOFileUpload ? res.data.sPOFileUpload.sPODriveId : null,
                spoItemId: res.data.sPOFileUpload ? res.data.sPOFileUpload.sPOItemId : null,
                spoWebUrl: res.data.sPOFileUpload ? res.data.sPOFileUpload.sPOWebUrl : null,
            }, () => {
                this.getUserProfile();
            })
    ...
    meetingCreate() {
        ...
        if (!this.state.edit) {
            ...
            const data = {
                ...
                "IsPartialMSGraphUpdate":this.state.IsPartialMSGraphUpdate?1:0,
                ...
                this.setState({
                    ...
                    if (type === 'Key Participants') {
                        this.setState({
                            keyParticipants: null,
                            participantsData: [],
                            suggestedTimeParticipantsList: (this.state.meetingType !== "Other" || this.state.meetingType !== "CFT") && [...this.state.suggestedTimeParticipantsList, { ParticipantName: ele.displayName, ParticipantEmail: ele.mail }]
                        })
    ...
    suggestedTime() {
        // console.log(" time diff", moment.utc(moment(this.state.endTimeHour + ":" + this.state.endTimeMin + ":00", "HH:mm:ss").diff(moment(this.state.startTimeHour + ":" + this.state.startTimeMin + ":00", "HH:mm:ss"))).format("HH:mm:ss"))
        const timeDiff = moment.utc(moment(this.state.endTimeHour + ":" + this.state.endTimeMin + ":00", "HH:mm:ss").diff(moment(this.state.startTimeHour + ":" + this.state.startTimeMin + ":00", "HH:mm:ss"))).format("HH:mm:ss")
    ...
    dropStatusFunction = (value: any) => {
        this.setState({
            ...
            if(this.state.dropStatus==='Existing OAAP Template'){
                this.setState({
                    spoDriveId:this.state.selectedSpoDriveId,
                    spoItemId:this.state.selectedSpoItemId,
                    meetingTitleFileName:this.state.selectedMeetingTitleFileName,
                    spoWebUrl:this.state.selectedSpoWebUrl
                })
            }
        })
    }
                                ...
                                <FlexItem size="size.half">
                                    <div className='leftSidePart'>
                                        <div className='d-flex justify-content-start align-items-center mb-3'>
                                            {/* <Tooltip trigger={<TagIcon  />} content="Type" styles={{marginRight:"10px"}}/> */}
                                            <FormDropdown
                                                fluid
                                        ...
                                        <div className='d-flex justify-content-start align-items-center mb-3'>
                                            {/* <Tooltip trigger={<EditIcon />} content="Title" styles={{marginRight:"10px"}}/> */}
                                            {((this.state.meetingType !== "Other") && (this.state.meetingType !== "CFT")) ? <FormDropdown
                                                fluid
                                                className='flex-fill ms-2 leftSidePartDropDown'
                                        ...
                                        <div className='d-flex justify-content-start align-items-center mb-3'>
                                            {/* <Tooltip trigger={<FilesAftereffectsIcon />} content="OAAP Template" styles={{marginRight:"10px"}}/> */}
                                        ...
                                        <div className='d-flex justify-content-start align-items-center mb-3'>
                                            {/* <Tooltip trigger={<ChannelShareIcon  />} content="Add channel" styles={{marginRight:"10px"}}/> */}
                                            <FormDropdown
                                                fluid
                                                className='flex-fill ms-2'
                                                disabled={this.state.channelInputList.length > 0 ? false : true}
                                                items={this.state.channelInputList}
                                                placeholder={this.state.channelName ? this.state.channelName : "Channel"}
                                                checkable
                                                search
                                        ...
                                        <div className='d-flex justify-content-start align-items-start mb-3'>
                                            {/* <Tooltip trigger={<NotesIcon />} content="Description" styles={{marginRight:"10px"}}/> */}
                                            <Editor
                                        ...
                                        {!this.state.edit && this.state.dropStatus === "Upload OAAP Template" ?
                                            ...
                                            this.state.edit && this.state.dropStatus === "Upload OAAP Template" ?
                                                ...
                                                !this.state.edit && this.state.dropStatus === "Existing OAAP Template" && this.state.spoWebUrl !== null ?
                                                    ...
                                                    :
                                                    this.state.edit && this.state.spoWebUrl !== null ?
                                                        <div className='d-flex justify-content-start align-items-start mb-3'>
                                                            <div className='flex-fill pr-3 pl-3'>
                                        ...
                                        <div className='leftSidePart'>
                                            ...
                                            <div className='d-flex justify-content-start mb-3 divgap' >
                                                <div className='me-2' style={{ 'lineHeight': '30px' }}>
                                                    {/* <Tooltip trigger={<CalendarIcon />} content="Start Date time" styles={{marginRight:"10px"}}/> */}
                                                </div>
                                            ...
                                            <div className='d-flex justify-content-start mb-3 divgap' >
                                                {/* <div className='me-2' style={{ 'lineHeight': '30px' }}>
                                                    <Tooltip trigger={<CalendarIcon />} content="End Date time" styles={{marginRight:"10px"}}/>
                                                </div> */}
                                            ...
                                            <div className='d-flex justify-content-start mb-3 divgap' >
                                                ...
                                                {/* <Tooltip trigger={<CalendarAgendaIcon />} content="Meeting Repeat Details" styles={{marginRight:"10px"}}/> */}
                                                ...
                                                <FormDropdown
                                                    ...
                                                    disabled={(this.state.edit && this.state.IsConducted) ? true : false}
                                            ...
                                            {(this.state.MeetingRepeatDetails === "Daily") ? <div className='d-flex justify-content-start mb-3 divgap'>
                                                <Flex gap="gap.small">
                                                    ...
                                                    <Flex.Item >
                                                        <FormDatepicker
                                                            ...
                                                            inputOnly
                                                            className="createMeetingDate"
                                                            onDateChange={(e: any, v: any) => this.eventEndDate(e, v)}
                                                            minDate={new Date(this.state.startDate)}
                                                            inputPlaceholder={moment(this.state.dailyEventEndDate).format('LL')}
                                                        />
                                                    </Flex.Item>
                                                    <Flex.Item >
                                                        <FormInput label="Repeat every (frequency)" placeholder='Repeat every' type="number" onChange={(e) => this.repeatEvery(e)} value={this.state.meetingRepeat} min="1" disabled={(this.state.edit && this.state.IsConducted) ? true : false} />
                                                    </Flex.Item>
                                                </Flex>
                                                ...
                                                <div className='d-flex justify-content-start mb-3 divgap mt-3'>
                                                    <Flex gap="gap.small">
                                                        ...
                                                        <Flex.Item >
                                                            <FormInput disabled={(this.state.edit && this.state.IsConducted) ? true : false} label="Repeat every (frequency)" placeholder='Repeat every' type="number" onChange={(e) => this.repeatEvery(e)} value={this.state.meetingRepeat} min="1" />
                                                        </Flex.Item>
                                                    </Flex>
                                                </div>
                                                <div className='d-flex justify-content-start align-items-center mb-3'>
                                                    ...
                                                    />
                                                    <Tooltip trigger={<InfoIcon />} content={(this.state.monthlyRepeatTypeValue === "On Date") ? "Meeting will occur every month on the specified date" : "Meeting will occurs on the day of that week of every month"} styles={{ marginLeft: "15px" }} />
                                                </div>
                                                ...
                                                <div className='d-flex justify-content-start align-items-center mb-3'>
                                                    ...
                                                    <FormDropdown
                                                        ...
                                                        disabled={(this.state.edit && this.state.IsConducted) ? true : false}
                                                    />
                                                    <Tooltip trigger={<InfoIcon />} content={(this.state.monthlyRepeatTypeValue === "On Date") ? "Meeting will occur every month on the specified date" : "Meeting will occur on this particular day of the specified week"} styles={{ marginLeft: "15px" }} />
                                                </div>
                                            ...
                                            <div className='d-flex justify-content-start align-items-center mb-3'>
                                                {/* <Tooltip trigger={<LocationIcon  />} content="Add Location" styles={{marginRight:"10px"}}/> */}
                                                <div style={{ marginTop: "2px", width: '100%' }}>
                                                    ...
                                                    <FormDropdown
                                                        fluid
                                                        className='flex-fill ms-2'
                                                        disabled={this.state.roomData.length > 0 ? false : true}
                                                        items={this.state.roomData}
                                                        placeholder={this.state.roomName ? this.state.roomName : "Add Location"}
                                                        checkable
                                                        search
                                                        onChange={(event, { value }) => this.selectRoomFunction(value)}
                                                    />
                                                </div>
                                            ...
                                            <div className='d-flex justify-content-start align-items-center mb-3'>
                                                {/* <Tooltip trigger={<SpeakerPersonIcon />} content="Add Anchor" styles={{marginRight:"10px"}}/> */}
                                                <div style={{ marginTop: "2px", width: '100%' }}>
                                                    <Input fluid value={this.state.anchorName} autoComplete="off"
                                                        placeholder={(this.state.meetingType !== "Other" || this.state.meetingType !== "CFT") ? "Anchor*" : "Anchor"} onChange={(e) => this.anchorSearch(e)} />
                                                    {(this.state.anchor) && <div className='searchList'>{!this.state.participantLoading ? <div>
                                                        {this.state.anchorData && (this.state.anchorData.length > 0) ? this.state.anchorData.map((ele: any, i: any) =>
                                                            <div key={i} className="displayFlex searchBox mt-2" onClick={() => this.selectAnchorFunction(ele)}>
                                                                <Persona text={ele.displayName + ' (' + ele.jobTitle + ')'} secondaryText={ele.mail} size={PersonaSize.size40} />
                                            ...
                                            <div className='d-flex justify-content-start align-items-center mb-3'>
                                                {/* <Tooltip trigger={<SpeakerPersonIcon />} content="Add Co Anchor" styles={{marginRight:"10px"}}/> */}
                                                <div style={{ marginTop: "2px", width: '100%' }}>
                                            ...
                                            <div className='d-flex justify-content-start align-items-center mb-3'>
                                                {/* <Tooltip trigger={<SpeakerPersonIcon />} content="Add Key Participants" styles={{marginRight:"10px"}}/> */}
                                                <div style={{ marginTop: "2px", width: '100%' }}>
                                                    <Input fluid autoComplete="off" value={this.state.keyParticipants} required
                                                        placeholder={(this.state.meetingType !== "Other" || this.state.meetingType !== "CFT") ? "Key Participants*" : "Key Participants"} onChange={(e) => this.keyParticipantsSearch(e)} />
                                            ...
                                            <div className='d-flex justify-content-start align-items-center mb-3'>
                                                {/* <Tooltip trigger={<SpeakerPersonIcon />} content="Add Participants" styles={{marginRight:"10px"}}/> */}
                                                <div style={{ marginTop: "2px", width: '100%' }}>
                                                    <Input fluid autoComplete="off" value={this.state.participants} required
                                                        placeholder={(this.state.meetingType !== "Other" || this.state.meetingType !== "CFT") ? "Participants" : "Participants*"} onChange={(e) => this.participantsSearch(e)} />
                                            ...
                                            <div className='d-flex justify-content-start align-items-center mb-3'>
                                                {/* <Tooltip trigger={<SpeakerPersonIcon />} content="Add External Participants" styles={{marginRight:"10px"}}/> */}
                                                <div style={{ marginTop: "2px", width: '100%' }}>
