...
class UpcomingConnects extends React.Component<MyState> {
    ...
    search = () => {
        const data = {
            ...
            "SysFromDateTime":moment().format('YYYY-MM-DD')+" "+moment().format('HH:mm:ss')
        }
                                    ...
                                    <div className='d-flex justify-content-between align-items-center'>
                                        ...
                                        <div className='d-flex'>
                                            <MenuButton trigger={<div className='pointer' ><img style={{ height: "25px", width: "25px" }} src={menuBtn} alt='' /></div>} aria-label="Click button"
                                                menu={[
                                                    ((e.anchorEmail && (this.state.userEmail.toLocaleLowerCase() ===  e.anchorEmail.toLocaleLowerCase())) || (this.state.userEmail.toLocaleLowerCase() === e.createdByEmail.toLocaleLowerCase()) || (e.userRole==="CoAnchors")) && <div className='d-flex align-items-center' onClick={() => this.editMeetingDetails(e)}>
                                                        {/* <Edit16Regular />  */}
                                                    ...
                                                    ((e.anchorEmail && (this.state.userEmail.toLocaleLowerCase() ===  e.anchorEmail.toLocaleLowerCase())) || (this.state.userEmail.toLocaleLowerCase() === e.createdByEmail.toLocaleLowerCase())|| (e.userRole==="CoAnchors")) && <div className='d-flex align-items-center' onClick={() => this.cancelMeetingDetails(e)}>
                                                        {/* <Dismiss16Regular /> */}
