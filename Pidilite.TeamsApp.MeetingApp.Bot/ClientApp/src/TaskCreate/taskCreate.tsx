...
const cancelImageDark = baseUrl + "/images/darkThemeCancel.png";
const cancelImageLight = baseUrl + "/images/cancel.svg";
                                    ...
                                    return <Flex column styles={{ marginBottom: "10px", marginTop: "5px" }} key={i}>
                                        <Flex space="between" styles={{ marginBottom: "5px", alignItems: "center" }} >
                                            ...
                                            <div className="pointer backButtonMessagingExtention" onClick={() => this.cancelEmployee(e)}>
                                                <img src={(this.state.openFrom === "inMeeting")?cancelImageDark:cancelImageLight} style={{ height: "20px" }} alt='Cancel' />
                                            </div>
