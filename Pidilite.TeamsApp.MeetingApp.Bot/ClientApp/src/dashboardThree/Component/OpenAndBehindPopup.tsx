...
import { GetDashboardPersonalTaskAssignByUser, GetDashboardPersonalTaskDetailsByMeetingID } from '../../apis/APIList';
...
export default class OpenAndBehindPopup extends React.Component<Props, State> {
    ...
    componentDidMount=()=>{
        ...
        const fromdate = query.get('fromdate')?query.get('fromdate'):""
        const todate = query.get('todate')?query.get('todate'):""
        this.getData(login, assigned, meeting, meetid, tsktyp, fromdate, todate )
        microsoftTeams.initialize();
    }



  getData=(UserEmail:any,AssignedToEmail?:any,MeetingTitleId?:any,MeetingTypeId?:any,TaskType?:any, Fromdate?:any, Todate?:any)=>{
    GetDashboardPersonalTaskDetailsByMeetingID(UserEmail, AssignedToEmail, MeetingTitleId, MeetingTypeId, TaskType, Fromdate, Todate)
    .then((res: any) => {
