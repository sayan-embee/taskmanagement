namespace Pidilite.TeamsApp.MeetingApp.Bot.Services.MicrosoftGraph
{
    ...
    public interface IUsersService
    {
        ...
        Task<IEnumerable<User>> GetUsersAsync(string filter = null, string userType = null);

        Task<IEnumerable<User>> GetUsersWithEmailDomainAsync(string filter = null, string domainFilter = null);
        ...
        Task<IEnumerable<User>> GetDirectReports(string userADID);
    }
}