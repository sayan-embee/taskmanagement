...
BEGIN
	...
	(
		ActivityId,ConversationId,RecipientId,RecipientName,ServiceUrl,UserEmail,TenantId,UserId,UserName,BotInstalledOn,UserPrincipalName
	)
	VALUES
	(
		@ActivityId,@ConversationId,@RecipientId,@RecipientName,@ServiceUrl,@UserEmail,@TenantId,@UserId,@UserName,GETUTCDATE(),@UserPrincipalName
	)
