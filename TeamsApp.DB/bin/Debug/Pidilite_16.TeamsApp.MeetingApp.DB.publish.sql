...
GO
PRINT N'Creating Table [dbo].[MeetingSPOFileUploadResponse]...';


GO
CREATE TABLE [dbo].[MeetingSPOFileUploadResponse] (
    [MeetingSPOFileId]   BIGINT             IDENTITY (1, 1) NOT NULL,
    [MeetingId]          BIGINT             NULL,
    [MeetingSPOFileName] NVARCHAR (500)     NULL,
    [FileGuidId]         NVARCHAR (100)     NULL,
    [SPOItemId]          NVARCHAR (100)     NULL,
    ...
    [SPOFolderId]        NVARCHAR (100)     NULL,
    [SPOFolderPath]      NVARCHAR (500)     NULL,
    PRIMARY KEY CLUSTERED ([MeetingSPOFileId] ASC)
);
