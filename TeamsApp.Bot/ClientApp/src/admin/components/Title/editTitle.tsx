...
import { getDivisionsAPI, getMeetingTypesAPI, getVerticalsAPI, getUserProfileAPI, getMeetingTitleByIdAPI, updateMeetingTitleAPI } from '../../../apis/APIList'
...
class EditMeetingTitle extends React.Component<IMeetingTitleEditProps, MyState> {
    ...
    componentDidMount() {
        ...
        console.log("sayan", params.get('id'))
        this.setState({
    ...
    getmeetingTitleData() {
        getMeetingTitleByIdAPI(this.state.titleId).then((res: any) => {
            console.log("sayan.", res)
            console.log("upload path", res.data.meetingTitleFileUpload)
            if (res.data) {
                ...
                console.log("MeetingTitle from getMeetingAPI", this.state.meetingTitle)
            }
        })
    }
    ...
    editMeetingTitle() {
        ...
        console.log("meeting title edit------------------", data)
        this.uploadedr(data)
        // updateMeetingTitleAPI(data).then((res: any) => {
