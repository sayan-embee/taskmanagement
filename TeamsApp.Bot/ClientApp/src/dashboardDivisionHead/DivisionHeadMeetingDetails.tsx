                    ...
                    <table className="tableDesign" width={'100%'}>
                        <thead className='tableDesHead'>
                            <tr>
                                ...
                                <th style={{ width: "8%", textAlign: "center", fontSize:"12px" }}>Scheduled No.<br/> of Meetings</th>
                                ...
                                return (
                                    <>
                                        ...
                                        <TableRow load={load} cells={
                                            ...
                                            <td style={{ width: "8%", textAlign: "center", fontSize:"12px" }} >{load.totalMeeting}</td>
                                            <td style={{ width: "8%", textAlign: "center", fontSize:"12px" }} >{load.totalScheduledMeeting}</td>
                                            <td style={{ width: "8%", textAlign: "center", fontSize:"12px" }} >{load.totalConductedMeetings}</td>
                                            <td style={{ width: "8%", textAlign: "center", fontSize:"12px" }} >{load.totalDocumentUploaded}</td>
                                            <td style={{ width: "8%", textAlign: "center", fontSize:"12px" }} >{load.totalCancelledMeeting}</td>
                                            </>
                                        }>
                                            <tr>
                                                                            ...
                                                                            <td colSpan={10} style={{ padding: "0" }}>
                                                                                <table style={{ width: "100%" }}>
                                                                                    {vertical.typeWiseData.map((typewise: any) => {
                                                                                        return (
                                                                                            <>
                                                                                            <TableRow load={typewise} cellsBefore={<> <td style={{ width: "10%" }}></td></>} cells={
                                                                                                <>
                                                                                                    <td style={{ width: "10%" }} className="tableAccordion">{typewise.typeName}</td>
                                                                                                    <td style={{ width: "20%" }}></td>
                                                                                                    <td style={{ width: "8%", textAlign: "center", fontSize:"12px" }}>{typewise.totalMeeting}</td>
                                                                                                    <td style={{ width: "8%", textAlign: "center", fontSize:"12px" }}>{typewise.totalScheduledMeeting}</td>
                                                                                                    <td style={{ width: "8%", textAlign: "center", fontSize:"12px" }}>{typewise.totalConductedMeetings}</td>
                                                                                                    <td style={{ width: "8%", textAlign: "center", fontSize:"12px" }}>{typewise.totalDocumentUploaded}</td>
                                                                                                    <td style={{ width: "8%", textAlign: "center", fontSize:"12px" }}>{typewise.totalCancelledMeeting}</td>
                                                                                                </>
                                                                                            }>
                                                                                                  <tr>
                                                                                                        <td colSpan={10} style={{ padding: "0" }}>
                                                                                                                    ...
                                                                                                                    return (
                                                                                                                        <>
                                                                                                                            <tr className='nestedTableRow'>
                                                                                                                                ...
                                                                                                                                <td style={{ width: "8%", textAlign: "center", fontSize:"12px" }} >{titlewise.totalMeeting}</td>
                                                                                                                                <td style={{ width: "8%", textAlign: "center", fontSize:"12px" }} >{titlewise.totalScheduledMeeting}</td>
                                                                                                                                <td style={{ width: "8%", textAlign: "center", fontSize:"12px" }} >{titlewise.totalConductedMeetings}</td>
                                                                                                                                <td style={{ width: "8%", textAlign: "center", fontSize:"12px" }} >{titlewise.totalDocumentUploaded}</td>
                                                                                                                                <td style={{ width: "8%", textAlign: "center", fontSize:"12px" }} >{titlewise.totalCancelledMeeting}</td>
                                                                                                                            </tr>
                                                                                                                        </>
                                                                                                                    )
                                                                                                                })}
