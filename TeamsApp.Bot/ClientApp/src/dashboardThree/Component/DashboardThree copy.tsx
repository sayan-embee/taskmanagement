              ...
              <table className="tableDesign" width={'100%'}>
                <thead className='tableDesHead'>
                  <tr>
                    ...
                    <th style={{ width: "22%", fontSize:"12px"}}>Meeting Title</th>
                    <th style={{ width: "10%", textAlign: "center", fontSize:"12px" }}>Name of the Emp</th>
                    <th style={{ width: "8%",  textAlign: "center", fontSize:"12px"}}>Total Tasks</th>
                    ...
                    return (
                      <>
                        <tr className='nestedTableRow' onClick={() => { this.toggleTop(i) }} style={{ cursor: "pointer" }}>
                          <td style={{ width: "1%", color:"#0c9965" }}>{this.state.isOpenOne[i] ? <span style={{color:"red"}}>-</span> : <span style={{color:"green"}}>+</span>}</td>
                          <td style={{ width: "10%" }} className="tableAccordion">{load.meetingType}</td>
                          <td style={{ width: "22%" }}></td>
                          <td style={{ width: "10%" }}></td>
                          <td style={{ width: "8%", textAlign: "center" }} className="tableAccordion">{load.totalTask}</td>
                          <td style={{ width: "8%", textAlign: "center" }} className="tableAccordion">{load.totalBehindSchedule}</td>
                          <td style={{ width: "8%", textAlign: "center" }} className="tableAccordion">{load.totalInProgress}</td>
                          <td style={{ width: "8%", textAlign: "center" }} className="tableAccordion">{load.totalClosed}</td>
                          <td style={{ width: "8%", textAlign: "center" }} className="tableAccordion">{load.totalBehindSchedulePercent}</td>
                          <td style={{ width: "8%", textAlign: "center" }} className="tableAccordion">{load.totalInProgressPercent}</td>
                          <td style={{ width: "8%", textAlign: "center" }} className="tableAccordion">{load.totalClosedPercent}</td>
                        </tr>

                        {/*  child */}
                        {this.state.isOpenOne[i] && load.titleWiseData && load.titleWiseData.length > 0 ?
                          <tr>
                            <td colSpan={12} style={{ padding: "0" }}>
                              <table width={'100%'}>
                                {load.titleWiseData.map((title: any, j: number) => {
                                  console.log("employeeWiseData inside child", title.employeeWiseData)
                                  ...
                                  return (
                                    <>
                                      <tr className='nestedTableRow' onClick={() => { this.toggleInner(i, j) }} style={{ cursor: "pointer" }}>
                                        {/* <td style={{width:"1%"}}></td> */}
                                        <td style={{ width: "10%" }}></td>
                                        <td style={{ width: "1%", color:"#0c9965" }}>{this.state.isOpenTwo[i][j] ? <span style={{color:"red"}}>-</span> : <span style={{color:"green"}}>+</span>}</td>
                                        <td style={{ width: "22%" }} className="tableAccordion" title={title.meetingTitle}>{this.elip(title.meetingTitle)}</td>
                                        <td style={{ width: "10%" }}></td>
                                        <td style={{ width: "8%", textAlign: "center" }} className="tableAccordion">{title.totalTask}</td>
                                        <td style={{ width: "8%", textAlign: "center" }} className="tableAccordion">{title.totalBehindSchedule}</td>
                                        <td style={{ width: "8%", textAlign: "center" }} className="tableAccordion">{title.totalInProgress}</td>
                                        <td style={{ width: "8%", textAlign: "center" }} className="tableAccordion">{title.totalClosed}</td>
                                        <td style={{ width: "8%", textAlign: "center" }} className="tableAccordion">{title.totalBehindSchedulePercent}</td>
                                        <td style={{ width: "8%", textAlign: "center" }} className="tableAccordion">{title.totalInProgressPercent}</td>
                                        <td style={{ width: "8%", textAlign: "center" }} className="tableAccordion">{title.totalClosedPercent}</td>
                                      </tr>

                                      {/* nested child */}
                                      {this.state.isOpenTwo[i][j] && title.employeeWiseData && title.employeeWiseData.length > 0 ?
                                                ...
                                                return (
                                                  <>
                                                    <tr className='nestedTableRow'>
                                                      ...
                                                      <td style={{ width: "10%" }}></td>
                                                      <td style={{ width: "22%" }}></td>
                                                      <td style={{ width: "10%", textAlign: "center" }} className="tableAccordion">{data3.assignedTo}</td>
                                                      <td style={{ width: "8%", textAlign: "center" }} className="tableAccordion">{data3.totalTask}</td>
                                                      ...
                                                      <td style={{ width: "8%", textAlign: "center" }} className="tableAccordion">{data3.totalBehindSchedule}</td>}
                                                      ...
                                                      <td style={{ width: "8%", textAlign: "center"}} className="tableAccordion">{data3.totalInProgress}</td>
                                                      }
                                                      {data3.totalClosed !== 0  ? 
                                                      ...
                                                      <td style={{ width: "8%", textAlign: "center"}} className="tableAccordion">{data3.totalClosed}</td>
                                                      }
                                                      <td style={{ width: "8%", textAlign: "center" }} className="tableAccordion">{data3.totalBehindSchedulePercent}</td>
                                                      <td style={{ width: "8%", textAlign: "center" }} className="tableAccordion">{data3.totalInProgressPercent}</td>
                                                      <td style={{ width: "8%", textAlign: "center" }} className="tableAccordion">{data3.totalClosedPercent}</td>
                                                    </tr>
                                                  </>
                                                )
                                              }
