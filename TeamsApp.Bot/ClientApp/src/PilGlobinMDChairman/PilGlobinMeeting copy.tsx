                    ...
                    <table className="tableDesign" width={'100%'}>
                        <thead className='tableDesHead'>
                            <tr>
                                ...
                                <th style={{ width: "8%" , fontSize:"12px"}}>Type of<br/> Meetings</th>
                                <th style={{ width: "18%" , fontSize:"12px"}}>Meetings Name</th>
                                ...
                                <th style={{ width: "6%", textAlign: "center", fontSize:"12px"}}>Conducted No.<br/>Meetings</th>
                                                                                                                                ...
                                                                                                                                <td colSpan={13} style={{ padding: "0" }}>
                                                                                                                                    ...
                                                                                                                                    return(
                                                                                                                                        ...
                                                                                                                                        <tr className='nestedTableRow'>
                                                                                                                                            ...
                                                                                                                                            <td style={{ width: "2%" }}></td>
                                                                                                                                            <td style={{ width: "18%" }}></td>
                                                                                                                                            <td style={{ width: "6%"}} className="tableAccordion">{emp.assignedTo}</td>
