...
{
    public class AdminActivityHandler : TeamsActivityHandler
    {
        /// <summary>
        /// Instance to send logs to the Application Insights service.
        /// </summary>
        private readonly ILogger<AdminActivityHandler> logger;
        ...
        private readonly string AppName = "AdminApp";

        public AdminActivityHandler(
            ILogger<AdminActivityHandler> logger,
